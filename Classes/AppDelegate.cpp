...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        glview = GLView::create("Photo Jigsaw");
#if (CC_TARGET_PLATFORM == CC_PLATFORM_WIN32)
		glview->setFrameSize(480,800);
		//glview->setFrameSize(640,960);
		//glview->setFrameSize(768,1280);
 ...
 //   }
	...
	// set backgroud music
	SimpleAudioEngine::getInstance()->preloadBackgroundMusic(FileUtils::getInstance()->fullPathForFilename(MUSIC_FILE).c_str());
